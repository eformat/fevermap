...
class FevermapDataEntry extends LitElement {
    ...
    firstUpdated() {
        ...
        setTimeout(() => {
            ...
            this.nextQuestion(() => this.handleDialogFocus('#question-1'));
        });
    }
    ...
    async buildFeverData() {
        ...
        feverData.location_lng = Number.parseFloat(geoCodingInfo.location_lng).toFixed(9);
        feverData.location_lat = Number.parseFloat(geoCodingInfo.location_lat).toFixed(9);
    ...
    render() {
      ...
      <div class="container view-wrapper fevermap-entry-dialog fevermap-entry-dialog--hidden">
        <div class="fevermap-data-entry-content">
          <div
            class="fevermap-entry-carousel${this.questionCount === 2
